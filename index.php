...
<body class="front-page">
        ...
        <a href="./" class="header-logo">
            ...
            <!-- <svg width="140" height="44" viewBox="0 0 140 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_191_1609)">
                    <path class="header-logo-path" fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div class="container">
            ...
            <div class="swiper features-slider">
                ...
                <ul class="swiper-wrapper header-features">
                    <!-- Slides -->
                    <li class="swiper-slide header-features-item"><svg width="36px" height="36px">
                            <use href="img/sprite.svg#Frame-36"></use>
                        </svg>
                        <p class="header-features-text">Непрерывная работа c 2017 года</p>
                    </li>
                    <li class="swiper-slide header-features-item"><svg width="36px" height="36px">
                            <use href="img/sprite.svg#Frame-34"></use>
                        </svg>
                        <p class="header-features-text">Вся продукция сертифицирована</p>
                    </li>
                    <li class="swiper-slide header-features-item"><svg width="36px" height="36px">
                            <use href="img/sprite.svg#Frame-33"></use>
                        </svg>
                        <p class="header-features-text">Контроль качества на всех этапах</p>
                    </li>
                    <li class="swiper-slide header-features-item"><svg width="36px" height="36px">
                            <use href="img/sprite.svg#Frame-37"></use>
                        </svg>
                ...
                <div class="slider-buttons">
                    <div class="slider-button-prev"><svg width="36px" height="24px">
                            <use href="img/sprite.svg#arrow-prev"></use>
                        </svg></div>
                    <div class="slider-button-next"><svg width="36px" height="24px">
        ...
        <div class="container">
            ...
            <div class="cards">
                ...
                <a href="#" class="card">
                    ...
                    <!-- /.card-content -->
                    <img src="/img/5dd4c227c7dc6914837490 1-1.png" alt="Бытовая химия" class="card-image">
                </a>
                <a href="#" class="card">
                    <div class="card-content">
                    ...
                    <img src="/img/5dd4c227c7dc6914837490 1.png" alt="Дезинфицирующие средства" class="card-image">
                </a>
                <a href="#" class="card">
                    <div class="card-content">
                ...
                <a href="#" class="card">
                    ...
                    <img src="/img/Без имени-2 1-1.png" alt="" class="card-image">
                </a>
                <a href="#" class="card">
                    <div class="card-content">
    ...
    <section class="section trademark">
        <div class="container">
            ...
            <div class="trademark-cards">
                ...
                <div class="trademark-card">
                    <svg width="180px" height="180px" class="trademark-card-logo">
    ...
    <div class="section section founder">
        ...
        <div class="container">
            ...
            <div class="swiper blog-slider">
                ...
                <div class="swiper-wrapper">
                    <!-- Slides -->
                    <a href="#" class="swiper-slide blog-card"><img src="img/blog/blog-photo1.jpg" alt=""
                    ...
                    <a href="#" class="swiper-slide blog-card"><img src="img/blog/blog-photo2.jpg" alt=""
                            class="blog-card-image">
