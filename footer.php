    <footer class="footer">
        <div class="container">
            <div class="footer-top">
                ...
                <a href="tel:+79196861014" class="footer-phone">+7 (919) 686-10-14</a>
                ...
                <div class="footer-menu-wrapper">
                    <ul class="footer-menu-list ">
                        ...
                        <li class="footer-menu-item"><a href="#"
                                class="footer-menu-link footer-menu-link-bold">Новости</a></li>
                        <li class="footer-menu-item"><a href="#"
                                class="footer-menu-link footer-menu-link-bold">Контакы</a></li>
